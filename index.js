...
/////////////////
const Rem chan = 'NAMA BOTMU'; 
const https://www.instagram.com/kann_kamuiii/?igshid=yxn2bbkjejoa = 'LINK INSTAGRAMU'; 
const telegram = 'LINK TELEMU'; 
const HANYA DIAKTIFKAN = 'KETIKA HANYA DIAKTIFKAN'; 
const https://youtube.com/channel/UCTZmNJm33MrNzs5DjuIsptw = 'LINK YTMU';
//const grupch1 = 'https://chat.whatsapp.com/IKzt5OUUKIgJSl03vey5pV'; 
//const grupch2 = 'https://chat.whatsapp.com/Hw9ZrOzhNHWIVHq7ty1KSk' ; 
const
{
   WAConnection,
   MessageType,
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@kann_kamuiiij')
